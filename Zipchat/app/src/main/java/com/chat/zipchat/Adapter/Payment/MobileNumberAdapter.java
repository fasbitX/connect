package com.chat.zipchat.Adapter.Payment;
...
import com.chat.zipchat.Activity.Payments.SendXLMActivity;
...
public class MobileNumberAdapter extends RecyclerView.Adapter<MobileNumberAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        Glide.with(mContext).load(arrayList.get(position).getProfile_picture()).error(R.drawable.defult_user).into(viewHolder.mListImgMobile);
