...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.mTxtStatus.setText("Available");
        Glide.with(mContext).load(StudentListTemp.get(position).getProfile_picture()).error(R.drawable.defult_user).into(viewHolder.mImgUserContact);
