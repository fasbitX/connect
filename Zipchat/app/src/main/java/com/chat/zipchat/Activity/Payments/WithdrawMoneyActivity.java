...
import com.chat.zipchat.Adapter.ViewPagerAdapter.WithdrawSavedCardPagerAdapter;
...
import static com.chat.zipchat.Common.BaseClass.DecimalConvertion;
...
import static com.chat.zipchat.Common.BaseClass.mImageToString;
...
public class WithdrawMoneyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void mWithdrawCardClick(GetWithdrawSavedCards getWithdrawSavedCards) {
        ...
        Glide.with(WithdrawMoneyActivity.this).load(url).error(R.drawable.defult_user).into(mImgUploadProof);
